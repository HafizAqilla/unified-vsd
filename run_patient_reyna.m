...
%
% This file contains the exact same clinical data as config/patient_reyna.m
% but is formatted as a standalone runnable script.
%
% USAGE:
%   Run from the MATLAB command window:
%        >> run run_patient_reyna
%
% OUTPUTS:
...
% ---- Path setup (required for unified-vsd main_run to be found) --------
...
%% =====================================================================
%  START EXACT CONTENT FROM patient_reyna.m
%% =====================================================================
...
diary(fullfile(results_dir, sprintf('console_%s_%s.txt', clinical.common.patient_name, scenario)));
