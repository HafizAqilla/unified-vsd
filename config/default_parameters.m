...
params.V0.RA = 3.5385;    % [mL]  Right atrial unstressed volume    — Source: Valenti Table 3.3 / Keisya baseline package
params.V0.RV = 8.4067;    % [mL]  Right ventricular unstressed V    — Source: Valenti Table 3.3 / Keisya baseline package
params.V0.LA = 2.3085;    % [mL]  Left atrial unstressed volume     — Source: Valenti Table 3.3 / Keisya baseline package
params.V0.LV = 3.5385;    % [mL]  Left ventricular unstressed V     — Source: Valenti Table 3.3 / Keisya baseline package
...
% Left ventricle
params.E.LV.EA = 3.5;       % [mmHg/mL]  Active elastance component — Source: Valenti Table 3.3 / Keisya baseline package
params.E.LV.EB = 0.08;      % [mmHg/mL]  Passive elastance component — Source: Valenti Table 3.3 / Keisya baseline package

% Right ventricle
params.E.RV.EA = 0.5;       % [mmHg/mL]  Active elastance component — Source: Zhang et al. 2019 / Keisya baseline package
params.E.RV.EB = 0.042;     % [mmHg/mL]  Passive elastance component — Source: Zhang et al. 2019 / Keisya baseline package

% Left atrium
params.E.LA.EA = 0.35;      % [mmHg/mL]  Active elastance component — Source: Zhang et al. 2019 / Keisya baseline package
params.E.LA.EB = 0.20;      % [mmHg/mL]  Passive elastance component — Source: Zhang et al. 2019 / Keisya baseline package

% Right atrium
params.E.RA.EA = 0.30;      % [mmHg/mL]  Active elastance component — Source: Zhang et al. 2019 / Keisya baseline package
params.E.RA.EB = 0.10;      % [mmHg/mL]  Passive elastance component — Source: Zhang et al. 2019 / Keisya baseline package
...
% Ventricular
params.Tc_LV_frac  = 0.265;   % LV contraction duration / T_HB — Source: Valenti Table 2.1 / Keisya baseline package
params.Tr_LV_frac  = 0.40;    % LV relaxation duration / T_HB — Source: Valenti Table 2.1 / Keisya baseline package
params.Tc_RV_frac  = 0.30;    % RV contraction duration / T_HB (kept aligned with LV)
params.Tr_RV_frac  = 0.40;    % RV relaxation duration / T_HB — Source: Valenti Table 2.1 / Keisya baseline package
...
params.C.SAR  = 1.33;             % [mL/mmHg]     Systemic arterial compliance — Source: Keisya baseline package
                                   % Tuned from C.SAR=1.00 and 1.30 to place adult SBP/DBP/MAP
                                   % inside the SHEET.xlsx baseline validation ranges.
...
params.R.SC   = 0.80;             % [mmHg·s/mL]   Systemic arteriolar resistance (MAP-consistent Keisya baseline)
...
params.V0.SAR  = 90.9;            % [mL]  Kept from Keisya baseline package; adult arterial IC remains validated.
...
ic(idx.V_RV)   = 120.0;   % [mL]    RVEDV seed from Keisya baseline package
