...
%% =====================================================================
params.vsd.rho_blood = 1060;                     % [kg/m^3] Blood density — Source: Levick JR (2010)
params.vsd.reference_gradient_mmHg = 50;         % [mmHg] Default reference gradient for orifice estimation
params.vsd.mode = 'linear_bidirectional';        % Default mode
params.vsd.area_mm2 = 0;                         % Default closed VSD area
params.vsd.diameter_mm = 0;                      % Default closed VSD diameter
params.vsd.Cd = 1.0;                             % Default discharge coefficient
