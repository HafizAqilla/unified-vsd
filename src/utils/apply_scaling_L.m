function params = apply_scaling_L(params_ref, patient)
% APPLY_SCALING
% -----------------------------------------------------------------------
...
%   Total circulating blood volume (BV) is estimated via Lean Body Mass (LBM):
...
%     Neonatal fallback (age < 1 yr): flat 82 mL/kg × BW
%     (Linderkamp et al. 1977; LBM formula not validated at this age).
...
%   [4] Feldschuh J & Enson Y (1977). Prediction of the normal blood volume.
%         Circulation 56(4):605-612. (BV/LBM: 82.0 mL/kg male, 84.2 mL/kg female;
%         LBM = 0.407×BW + 26.7×H − 19.2 for males/Tanner-1 females.)
%
...
% --- Blood volume budget (LBM-based method) ---------------------------------
%   Source: Feldschuh & Enson (1977), Circulation 56(4):605-612.
...
if age_years < 1
    ...
    fprintf('[apply_scaling_L] BV (neonatal fallback): %.0f mL (82 mL/kg × %.1f kg)\n', ...
    ...
    fprintf('[apply_scaling_L] LBM=%.2f kg | BV/LBM=%.1f mL/kg | BV_patient=%.0f mL\n', ...
