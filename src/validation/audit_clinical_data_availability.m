...
rows = {
    ...
    'pre_surgery', 'LVEF', 'LV ejection fraction', '-', 'directly_derived', 'Alias for EF when patient files store the explicit LV label.'
...
rows = {
    ...
    'post_surgery', 'LVEDP_mmHg', 'LV end-diastolic pressure', 'mmHg', 'direct_reported', 'Post-op catheter pressure if reported.'
    'post_surgery', 'RVEDP_mmHg', 'RV end-diastolic pressure', 'mmHg', 'direct_reported', 'Post-op catheter pressure if reported.'
    ...
    'post_surgery', 'LVEF', 'LV ejection fraction', '-', 'directly_derived', 'Alias for EF when patient files store the explicit LV label.'
