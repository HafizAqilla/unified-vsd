...
%   gate  = 0.5 + 0.5·tanh(ΔP / ε)    sigmoid, ε = params.epsilon_valve
%
% INPUTS:
...
%   epsilon_valve = 0.1 mmHg is chosen to preserve >99% of diastolic
...
dP   = P_LV - P_RV;                                       % [mmHg]
gate = 0.5 + 0.5 * tanh(dP / params.epsilon_valve);       % smooth L→R diode
