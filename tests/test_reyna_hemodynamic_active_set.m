...
%% Test 2: allowedMetricFields contains only pressure-flow primary targets
...
%% Test 3: group.R_sys_scale bounds match pre-merge sparse_cath [0.25, 2.80]
...
%% Test 4: group.R_pul_scale bounds match pre-merge sparse_cath [0.45, 2.80]
...
%% Test 5: consistency-only rows are not in active calibration set
...
%% Test 6: registry calibratable flag is set correctly for all active params
